...
import {editCocktail, fetchGlasses, fetchIngredients, getCocktailById,} from '../actions/cocktailsActions';
import {Button, Grid, IconButton, makeStyles, MenuItem, Snackbar, TextField, Typography,} from '@material-ui/core';
...
const EditCocktailPage = () => {
    ...
    useEffect(() => {
        if (cocktail) {
            ...
            setIngredients(cocktail.cocktailIngredients);
            setInstruction(cocktail.instruction);
        }
    }, [cocktail]);
    ...
    const handleSubmit = async (e) => {
        ...
        await dispatch(editCocktail(id, updatedCocktail));
